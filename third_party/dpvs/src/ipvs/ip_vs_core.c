                                       ...
                                       struct rte_mbuf *mbuf)
{
    ...
    printf("\033[32m[INFO] dp_vs_snat_schedule\033[0m\n");
                                  ...
                                  bool is_synproxy_on)
{
    ...
    printf("\033[32m[INFO] dp_vs_schedule\033[0m\n");
    ports = mbuf_header_pointer(mbuf, iph->len, sizeof(_ports), _ports);
    if (!ports)
        return NULL;
                      ...
                      const struct inet_hook_state *state, int af)
{
    ...
    printf("\033[32m[INFO] dp_vs_in\033[0m\n");
    cid = peer_cid = rte_lcore_id();
    ...
    printf("\033[32m[INFO] iph.proto: %d\033[0m\n", iph.proto);
